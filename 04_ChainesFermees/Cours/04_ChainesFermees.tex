...
Détermination des lois Entrée -- Sorties }{
}}
...
CI 4 : CIN -- Cours \\
Ch 4 : Chaînes fermées -- Lois entrée -- sortie -- \ifthenelse{\boolean{prof}}{P}{E}%
}{
}}

\usepackage[%
    pdftitle={CIN : Chaînes fermées -- Lois entrée -- sortie},
