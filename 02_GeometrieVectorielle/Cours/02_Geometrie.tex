...
\begin{flushright}
D'après cours de géométrie de Pierrick Soleillant \cite{PS}.
\end{flushright}
\vspace{.5cm}
...
\bibitem[1]{PS} Pierrick Soleillant, Cours de Mathématiques de CPGE. Rappels de géométrie plane -- Géométrie plane élémentaire -- Géométrie dans l'espace élémentaire.
   \bibitem[2]{cite1} Renault, \textit{Au c\oe{}ur de la technique}, \url{www.renault.com/fr/Innovation/au-coeur-de-la-technique/Pages/au-coeur-de-la-technique.aspx}.
\end{thebibliography}
\end{document}
